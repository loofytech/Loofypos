...
>
  <head>
    ...
    <title>Loofypos | Dashboard</title>
      ...
      <div class="layout-container">
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand main">
            <a href="{{ route('dashboard', LoofyHelper::getActiveStore()) }}" class="app-brand-link">
              ...
              <span class="app-brand-text main menu-text fw-bolder ms-2">Loofypos</span>
            </a>
          ...
          <div class="content-wrapper">
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                ...
                <div>
                  <a href="https://loofytech.com" target="_blank" class="footer-link me-4">Loofytech</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
